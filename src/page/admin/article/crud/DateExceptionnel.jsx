...
import CRUDdateexceptionnel from '../../../../component/crudsimple/dateexceptionnel/CRUDdateexceptionnel';
import logo from '../../../../datajson/statique/logo';

export default function DateExceptionnel(){
    return(
            ...
            <div className="container-fluid page-body-wrapper">
                ...
                <div className="main-panel">
                    <div className="content-wrapper">
                       <CRUDdateexceptionnel></CRUDdateexceptionnel>
                    </div>
                </div>
            </div>
        </div>
