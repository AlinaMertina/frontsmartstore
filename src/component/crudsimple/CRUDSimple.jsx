...
export default function CRUDSimple({lien,size,name,detaillelink,nomdetaille}){
  ...
  useEffect(() => {
    ...
    return(
        <div className="row whitebackcolor">
          ...
          <Table data={data} lien={lien} name={name} detaillelink={detaillelink} nomdetaille={nomdetaille}></Table>
