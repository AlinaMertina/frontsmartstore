...
export default function DetailleCommande({data,dataFixeDate,dataAnulation,choixElementGauchePF,numboncommande,setModificationValue}){
    return(
        <>
                    ...
                    <div class="table-responsive" style={styles.overscroll}>
                        ...
                        <thead style={styles.theadTh}>
                            <tr>
                                ...
                                <th style={styles.titreViollete} >Changement etat</th>
                            </tr>
                        </thead>
                        <tbody>
                            {data && data.map((value,index)=>(
                                <Tr key={index} data={value} dataFixeDate={dataFixeDate} dataAnulation={dataAnulation}  setModificationValue={setModificationValue}></Tr>
                                ))
                            }
                        </tbody>
                        </table>
