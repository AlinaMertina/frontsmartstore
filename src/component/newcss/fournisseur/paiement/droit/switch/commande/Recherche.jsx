...
export default function Recherche({setChoixDroit,dateBetween,setDateBetween,submit,
realod}){
                ...
                <div class="card" style={styles.backgroundColorGauche}>
                    <div class="card-body" >
                        ...
                        <form onSubmit={submit} class="forms-sample">
                            ...
                            &nbsp;&nbsp;
                            <button type="button" class="btn btn-inverse-secondary btn-fw" onClick={realod} ><i className='mdi mdi-autorenew'></i></button>
                        </form>
                    </div>
                </div>
            </div>
