...
export default function Ajout({lien,listerole,choix1,setChoix}){
           ...
           <div  class="col-11  ml-3 ">
                <div class="card" style={styles.backgroundColorGauche}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <a   class="nav-link"   style={styles.titreViollete} onClick={notification}>
                    ...
                    <form  onSubmit={submit} class="forms-sample">
                            <div class="form-group">
                              <label for="exampleInputUsername1" style={styles.titreGris}>Photo</label>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="exampleInputUsername1" placeholder="user" onChange={handleChange} style={styles.backgroundColorDroit} name='login' />
                            </div>
                            <div class="form-group">
                              <label for="exampleInputUsername1" style={styles.titreGris}>Email</label>
                              <input type="text" class="form-control" id="exampleInputUsername1" placeholder="email"  onChange={handleChange} style={styles.backgroundColorDroit} name='email'/>
                            </div>
                            <div class="form-group">
                              <label for="exampleInputUsername1" style={styles.titreGris}>Mot de passe</label>
                              <input type="text" class="form-control" id="exampleInputUsername1" placeholder="mot de passe" onChange={handleChange} style={styles.backgroundColorDroit} name='password'/>
                            </div>
                            <div class="form-group">
