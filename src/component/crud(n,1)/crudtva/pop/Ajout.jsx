...
export default function Ajout({lien,nom,moi,reInitialisationVu,size}){
  const [error, setError] = useState(null);
    ...
    const handleChange = (e) => {
        ...
        setFormData({ ...formData, [e.target.name]: e.target.value, ['idutilisateur']: user.id,['date']: new Date() });
                ...
                <div className="content-popup modifcontent-pop">
                  ...
                  <div className="col-md-8 ">
                    ...
                    <form onSubmit={submit}  className="forms-sample">
                        ...
                        <div className="form-group">
                            <input type="text" className="form-control" id="exampleInputUsername1"  onChange={handleChange} placeholder="0.0" name='value'/>
                        </div>
